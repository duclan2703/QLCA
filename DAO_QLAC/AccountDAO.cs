...
namespace DAO_QLAC
{
    ...
    {
        public void CreateNewDAO(Account account)
        {
            try
            {
                cnn.Open();
        ...
        public void CreateRoleDAO(int roleid, int userid)
        {
            try
            {
                cnn.Open();
        ...
        public Account GetbykeyDAO(int id)
        {
            cnn.Open();
            Account account = new Account();
        ...
        public void UpdatePasswordDAO(Account account)
        {
            try
            {
                cnn.Open();
        ...
        public Account GetByUsernameDAO(string username)
        {
            cnn.Open();
            Account account = new Account();
        ...
        public int GetUserIDByUsernameDAO(string username)
        {
            cnn.Open();
            Account account = new Account();
        ...
        public string GetNameByUserNameDAO(string username)
        {
            cnn.Open();
            Account account = new Account();
        ...
        public Account GetAccountLoginDAO(string username)
        {
            Account account = new Account();
            {
        ...
        //    }
        //}
        public int GetOfficeIDNameByUsernameDAO(string username)
        {
            cnn.Open();
        ...
        public int GetShiftIDByShiftNameDAO(string name)
        {
            cnn.Open();
        ...
        public string GetShiftNameByShiftIDDAO(int shiftid)
        {
            cnn.Open();
        ...
        public List<Account> GetNamebyOfficeIDDAO(int office)
        {
            cnn.Open();
            List<Account> result = new List<Account>();
        ...
        public int GetUserIDByNameDAO(string name)
        {
            cnn.Open();
            Account account = new Account();
        ...
        public int GetOfficeIDByUserIDDAO(int id)
        {
            cnn.Open();
            Account account = new Account();
        ...
        public List<Account> GetListAccountDAO()
        {
            cnn.Open();
            List<Account> result = new List<Account>();
        ...
        public string GetAccountPasswordDAO(string username)
        {
            cnn.Open();
            Account account = new Account();
        ...
        public string GetNameByUserIDDAO(int userid)
        {
            cnn.Open();
            Account account = new Account();
